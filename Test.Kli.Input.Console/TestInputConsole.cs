...
namespace Kli.Input.Console
{
    public class TestInputConsole
    {
        ...
        [InlineData(0, 0,
            "texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior.")]
        [InlineData(10, 0,
            "texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior.")]
        [InlineData(0, 10,
            "texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior, texto bem maior.")]
        ...
        [InlineData(true, 0, 0,
            "teste\b\b\b\b\b\b\b\b\b\b\b\b\b\bnovamente muito-texto-muito-texto-muito-texto-muito-texto-muito-texto-muito-texto-muito-texto-muito-texto-muito-texto-muito-texto.")]
        ...
        public void
            num_console_de_3x3_confere_posicionamento_do_cursor_entre_linhas_ao_usar_backspace_com_ReadLine_isSensitive(
                string texto, int posiçãoEsperadaAntesDoEnterDeCursorTop, int posiçãoEsperadaAntesDoEnterDeCursorLeft)
        {
            // Arrange, Given
        ...
        public void
            num_console_de_3x3_confere_posicionamento_do_cursor_entre_linhas_ao_usar_backspace_com_Read_isSensitive(
                string texto)
        {
            // Arrange, Given
        ...
        public void
            num_console_de_3x3_confere_posicionamento_do_cursor_entre_linhas_quando_posicionado_em_1x1_ao_usar_backspace_com_Read_isSensitive(
                string texto, int posiçãoEsperadaAntesDoEnterDeCursorTop, int posiçãoEsperadaAntesDoEnterDeCursorLeft)
        {
            // Arrange, Given
        ...
        public void o_método_Read_deve_apagar_o_texto_digitado_e_retornar_o_cursor_para_a_posição_inicial()
        {
            ...
            console.Received(2)
                .SetCursorPosition(cursorLeft,
                    cursorTop > 0 ? cursorTop - 1 : 0); // Por causa do avanço de linha deve ser CursorTop-1
        }
        ...
        [Fact]
        public void
            os_métodos_Read_e_ReadLine_deve_exibir_asterisco_para_cada_letra_digitada_quando_isSensitive_é_true()
        {
            // Arrange, Given
        ...
        public void verificações_declarativas()
        {
            ...
            var sut = typeof(InputConsole);

            // Assert, Then

            sut.AssertMyImplementations(
                typeof(IInput),
                typeof(IInputConsole));
