...
namespace Kli.Infrastructure
{
    public class TestDependencyResolver
    {
        ...
        public void deve_ser_capaz_de_adicionar_serviços_via_Type_como_parâmetro()
        {
            ...
            Action adicionar = () => dependencyResolver.Register(typeof(SimulationToTestDependencyResolver),
                typeof(SimulationToTestDependencyResolver));
        ...
        public void deve_ser_capaz_de_obter_um_serviço_via_Type_como_parâmetro()
        {
            ...
            var dependencyResolver = new DependencyResolver() as IDependencyResolver;
            dependencyResolver.Register(typeof(SimulationToTestDependencyResolver),
                typeof(SimulationToTestDependencyResolver));
        ...
        public void dispara_exception_ao_obter_um_serviço_via_Type_como_parâmetro_de_um_escopo_não_existente()
        {
            ...
            var escopoQueNãoExiste = this.Fixture<Guid>();
            dependencyResolver.Register(typeof(SimulationToTestDependencyResolver),
                typeof(SimulationToTestDependencyResolver), DependencyResolverLifeTime.PerScope);
            ...
            verifica_se_a_liberação_do_escopo_libera_as_instâncias_associadas_em_escopos_filhos_quando_via_Type_como_parâmetro()
        {
            ...
            var instânciaNoPai =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopoPai);
            var instânciaNoFilho =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopoFilho);
            var instânciaNoNeto =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopoNeto);
        ...
        public void verifica_se_a_liberação_do_escopo_libera_as_instâncias_associadas_quando_via_Type_como_parâmetro()
        {
            ...
            var instância =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopo);
            instância.Disposed += () => liberadoQuantasVezes++;
        ...
        public void verifica_se_está_sendo_respeitado_o_escopo_do_serviço_tipo_PerContainer_via_Type_como_parâmetro()
        {
            ...
            // ReSharper disable once RedundantArgumentDefaultValue
            dependencyResolver.Register(typeof(SimulationToTestDependencyResolver),
                typeof(SimulationToTestDependencyResolver), DependencyResolverLifeTime.PerContainer);
        ...
        public void verifica_se_está_sendo_respeitado_o_escopo_do_serviço_tipo_PerScope_via_Type_como_parâmetro()
        {
            ...
            var instância1A =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopo1);
            var instância1B =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopo1);
            var escopo2 = dependencyResolver.CreateScope();
            var instância2A =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopo2);
            var instância2B =
                (SimulationToTestDependencyResolver) dependencyResolver.GetInstance(
                    typeof(SimulationToTestDependencyResolver), escopo2);
        ...
        public void verificar_se_lista_de_interfaces_com_múltiplas_implementações_está_correta()
        {
            ...
            interfacesComMúltiplasImplementações.Should()
                .BeEquivalentTo(typeof(IOutput), typeof(IInput), typeof(IModule));
        }
    }
}