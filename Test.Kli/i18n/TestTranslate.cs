...
namespace Kli.i18n
{
    public class TestTranslate
    {
        ...
        public void ao_carregar_traduções_de_dicionário_com_valores_incompletos_deve_retornar_zero_valores_inseridos()
        {
            ...
            {
                {this.Fixture<string>(), new Dictionary<string, string>()},
                {this.Fixture<string>(), null}
            };
        ...
        [Fact]
        public void
            ao_carregar_traduções_de_dicionário_deve_retornar_os_valores_inseridos_sem_ser_uma_referência_direta()
        {
            // Arrange, Given
            ...
            {
                {
                    this.Fixture<string>(), new Dictionary<string, string>
                    {
                        {this.Fixture<string>(), this.Fixture<string>()}
                    }
                },
                {
                    this.Fixture<string>(), new Dictionary<string, string>
        ...
        [Fact]
        public void
            ao_carregar_traduções_de_dicionário_não_deve_aceitar_duplicações_pois_os_últimos_valores_sobrescrevem_os_primeiros()
        {
            // Arrange, Given
        ...
        [Fact]
        public void
            ao_carregar_traduções_de_recurso_embutido_com_valores_incompletos_deve_retornar_zero_valores_inseridos()
        {
            // Arrange, Given
        ...
        [Fact]
        public void
            ao_carregar_traduções_de_recurso_embutido_com_valores_inválidos_deve_retornar_zero_valores_inseridos()
        {
            // Arrange, Given
        ...
        [Fact]
        public void
            ao_carregar_traduções_de_recurso_embutido_não_deve_aceitar_duplicações_pois_os_últimos_valores_sobrescrevem_os_primeiros()
        {
            // Arrange, Given
  ...
  {{
    ...
    ""Value"": null
        ...
        public void ao_carregar_traduções_de_texto_deve_retornar_os_valores_inseridos()
        {
            ...
            var valorTexto = this.Fixture<string>();
            var valorIdioma = this.Fixture<string>();
            var valorTradução = this.Fixture<string>();
            var conteudo = $@"
[
  {{
    ""Key"": ""{valorTexto}"",
    ""Value"": [
      {{
        ...
        [Fact]
        public void
            ao_carregar_traduções_de_texto_não_deve_aceitar_duplicações_pois_os_últimos_valores_sobrescrevem_os_primeiros()
        {
            // Arrange, Given
            ...
            var valorTexto = this.Fixture<string>();
            var valorIdioma = this.Fixture<string>();
            var valorTradução1 = this.Fixture<string>();
            var valorTradução2 = this.Fixture<string>();
    ...
    ""Value"": [
      {{
        ...
        public void deve_retornar_a_tradução_no_idioma_especificado_ao_invés_do_idioma_padrão()
        {
            ...
            var valorTexto = this.Fixture<string>();
            var valorIdiomaPadrao = this.Fixture<string>();
            var valorIdiomaDoTexto = this.Fixture<string>();
            var valorTradução = this.Fixture<string>();
